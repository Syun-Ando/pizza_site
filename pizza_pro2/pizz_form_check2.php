        ...
        <header class="header">
            ...
            <nav>
                <ul class="gnav-list-1">
                    ...
                    <li><a href="pizz_main2.html">ORDER<br>オーダー</a></li>
                </ul>
            </nav>
            </h1>
        </header>
...
<!-- body内の要素をここから下に書く -->
    <body>
        ...
        // }
        // // 160行目 pizz_form_done.php -> pizz_form_done2.phpに変更したのみ
        //     //エラーキャッチ
        //     try{
        //         //データベースへ接続する
        ...
        //         //データ表示
            ...
            if($okflg==true)
                {
                    print '<form  method="post" action="pizz_form_done2.php">';
        ...
        <div class="wrapper clearfix">
            <main class="main1">
            <form method="post" class="h-adr" action="pizz_form_done2.php">
                <div class="clearfix">
